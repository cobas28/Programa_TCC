...
#______________________________________Modelagem da Planta__________________________________________________
...
Ntsai = nsai                                          # Parâmetro continuo do GA 
Nter =ner                                             # Parâmetro continuo do GA 
Ntder =nder                                           # Parâmetro continuo do GA 
...
#______________________________________Critério de Parada___________________________________________________

maxit = 100                                     #Número de iterações

#___________________________________Criação das populações iniciais_________________________________________
...
pts_derro = np.zeros((popsize, nder))           #Matriz com os pontos da função de pertinência derro
...
#________________________________Avaliação da População Inicial_____________________________________________
...
#______________________________________Loop de Iterações das Gerações_______________________________________
...
#_________________________________________Cruzamento Aritimético____________________________________________
...
#_____________________________________Aplicando mutação na população________________________________________
...
#_____________________________Avaliação das População apos o cruzamento e mutações__________________________
