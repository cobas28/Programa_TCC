...
local_erro = np.copy(pts_erro)                   #Matriz que guarda as melhores posições adquiridas por cada membro da população erro
local_derro = np.copy(pts_derro)                 #Matriz que guarda as melhores posições adquiridas por cada membro da população derro
