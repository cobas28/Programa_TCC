...
for iga in range (1,maxit):         
    ...
    parceiro1=np.random.rand(M)                    # parceiro #1
    parceiro2=np.random.rand(M)                    # parceiro #2
    ma = np.zeros(M, dtype = 'int')                # ma e pa possuem os indices dos cromossomos que realizaram o cruzamento
