...
def simula_controle(erro, derro, saida, y1):
    ...
    # Método para discretizar o sistema pelo Metodo de Euller
...
nvar = 3                                              # Número de varáveis a modificar na solução vizinha
...
#_____________________________________________Inicializando as variáveis Erro, Derro e saida_______________________________________________________________________________________
...
custo_min = np.zeros(maxit)                 # Vetor que contém os valores mínimos de custo para cada iteração
custo_min[0] = custo
