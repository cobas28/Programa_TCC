...
pop_erro, pop_derro, pop_saida = func_pertinencia(pop_global_erro, pop_global_derro, pts_saida)
...
'''
with open('./dados2.pkl', 'wb') as arquivo:
    pickle.dump(y2, arquivo)
    
with open('./custo2.pkl', 'wb') as arquivo:
