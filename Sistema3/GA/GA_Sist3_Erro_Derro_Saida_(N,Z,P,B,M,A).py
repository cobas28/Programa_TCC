...
for i in range(popsize):
    ...
    pts_B = (0.5, np.random.uniform(0.5, min(1,M_center)),  1)
    B_center = pts_B[0]
    B_right = pts_B[1]
    B_left = pts_B[2]
    ...
    pts_A = (1, np.random.uniform(max(1,M_center), 1.5),  1.5)
    A_left = pts_A[0]
    A_center = pts_A[1]
    A_right = pts_A[2]
...
#_____________________________________Aplicando mutação na população________________________________________________________________________________________________________________________________________________________________________
    ...
    mut_col_saida = np.random.randint(0,Ntsai,nmut)                      
...
'''
with open('./novodados6.pkl', 'wb') as arquivo:
    pickle.dump(y2, arquivo)

with open('./novocusto6.pkl', 'wb') as arquivo:
