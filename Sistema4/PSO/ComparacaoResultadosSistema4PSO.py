...
def calculo_tempos(y,tempo):
    ...
    y_final = 11  # Último valor da curva de controle
    tempo_subida = 0
...
limite_inferior_x = 0
limite_superior_x = 10

limite_inferior_y = 0
limite_superior_y = 5

ind_min_y3 = np.argmax(y3)
val_min_y3 = np.max(y3)
...
#plt.scatter(tempo[ind_min_y3], val_min_y3, color='r', marker='o')
...
#plt.legend(loc=1,bbox_to_anchor=(1.0, 0.9),frameon=False)
...
plt.legend(loc=1,bbox_to_anchor=(1.0, 0.6),frameon=False)
plt.xlim(0, maxit)
