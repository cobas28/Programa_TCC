...
with open('./novodados9.pkl', 'rb') as arquivo:
    y2 = pickle.load(arquivo)

with open('./novodados7.pkl', 'rb') as arquivo:
    y3 = pickle.load(arquivo)

with open('./novodados10.pkl', 'rb') as arquivo:
    y4 = pickle.load(arquivo)

with open('./novodados11.pkl', 'rb') as arquivo:
    y5 = pickle.load(arquivo)

with open('./novodados12.pkl', 'rb') as arquivo:
    y6 = pickle.load(arquivo)

# Carregar dados do arquivo de custos
with open('./novocusto8.pkl', 'rb') as arquivo:
    c1 = pickle.load(arquivo)

with open('./novocusto9.pkl', 'rb') as arquivo:
    c2 = pickle.load(arquivo)

with open('./novocusto7.pkl', 'rb') as arquivo:
    c3 = pickle.load(arquivo)

with open('./novocusto10.pkl', 'rb') as arquivo:
    c4 = pickle.load(arquivo)

with open('./novocusto11.pkl', 'rb') as arquivo:
    c5 = pickle.load(arquivo)

with open('./novocusto12.pkl', 'rb') as arquivo:
